...
## Goal
Define maximum data age and confidence caps for tactical silver decisions.
...
### Market quotes
- Silver price, futures, `SLV`, gold/silver ratio, and short-term support or resistance:
...
- Manufacturing, PMI, solar, fabrication, electronics, or warehouse / inventory data
- Maximum age for tactical use: 30 calendar days
- If older than 30 calendar days: use as structural background only
...
- If ETF flows or industrial-demand data are fresh enough for context but market and macro data are weak:
