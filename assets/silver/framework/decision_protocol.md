...
## Required structure
Every silver decision must follow this order:
...
- Statements such as "silver is trading like an industrial metal" belong in Interpretation unless paired with explicit measured evidence
- Interpretation must explain the meaning of facts and may not introduce uncited new facts
- Apply `assets/silver/framework/freshness_rules.md` before assigning confidence or tactical weight
